...
# -*- coding: utf-8 -*-
"""
Custome BPF EMerge Structure Viewer V3 (Custom Pattern)
기판 20x20mm (1.2mm 두께), 에어박스 40x40mm
사용자 지정 50x50 (10x10mm) 패턴, 대각선 제거
주파수: 0.1~30GHz (구간별 109포인트)
EMerge 내장 자체 플롯(.show) 전용 시각화 스크립트
"""
...
def main():
    ...
    airmat = em.Material(name="Air", color='#87ceeb', opacity=0.1)
    
    m = em.Simulation('custome_structure_v3_custom_50x50')
    ...
    print("Starting Structure Visualization...")
    ...
    m.display.show()
    print("✅ Done (Structure Viewer V3 Custom)")
