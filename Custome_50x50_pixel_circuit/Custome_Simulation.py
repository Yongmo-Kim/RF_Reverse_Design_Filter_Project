...
사용자 지정 커스텀 50x50 (10x10mm) 모자이크 패턴 (대각선 제거)
...
def main(output_dir: Path = None, visualize: bool = False):
    if output_dir is None:
        output_dir = Path("/scratch/home/bhj101500/Coral1")
    ...
    sim_name = 'custome_bpf_v3_custom_50x50'
    ...
    # Export S2P
    s2p_file = s2p_dir / f"{sim_name}_50x50.s2p"
    ...
    try:
        ...
        png_file = png_dir / f"{sim_name}_50x50.png"
    ...
    # Export NPZ
    npz_file = npz_dir / f"{sim_name}_50x50.npz"
    np.savez_compressed(
        npz_file,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='/scratch/home/bhj101500/Coral1')
