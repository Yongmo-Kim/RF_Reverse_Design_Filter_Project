...
# -*- coding: utf-8 -*-
"""
Random BPF GMSH Viewer (Seed-based)
- GMSH 전용 3D 메쉬 시각화창 띄우기
"""
...
def main(seed: int, visualize: bool = True):
    ...
    m = em.Simulation(f'gmsh_50x50_seed{seed}')
    ...
    print(f"✅ Done (GMSH Viewer Seed={seed})")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GMSH Viewer")
