...
# -*- coding: utf-8 -*-
"""
Random BPF PyVista Viewer (Seed-based)
- PyVista 기반 미려한 3D 메쉬 스크린샷 렌더링
"""
...
def main(seed: int, save_path: str = None, offscreen: bool = False):
    ...
    m = em.Simulation(f'pyvista_50x50_seed{seed}')
    ...
    import gmsh
    # Pyvista needs explicit setSize on entire model occasionally for visual rendering
    gmsh.model.mesh.setSize(gmsh.model.getEntities(0), MAX_EDGE * mm)
    m.mesher.set_boundary_size(airbox, MAX_EDGE * mm)
    ...
    print(f"✅ Done (PyVista Viewer Seed={seed})")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PyVista Viewer")
    ...
    main(seed=args.seed, save_path=args.save, offscreen=args.offscreen)
