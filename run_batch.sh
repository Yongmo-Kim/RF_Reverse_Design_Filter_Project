...
#PBS -j oe
#PBS -o /scratch/home/yongmo0415/Coral1/result/log/

# 1. 계정 및 가상환경 설정
cd /scratch/home/yongmo0415/Coral1
...
# 로그 폴더 생성
mkdir -p /scratch/home/yongmo0415/Coral1/result/log
...
do
    INDIVIDUAL_LOG="/scratch/home/yongmo0415/Coral1/result/log/seed_${SEED}.log"
